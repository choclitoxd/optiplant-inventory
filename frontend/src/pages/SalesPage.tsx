    ...
    <div className="min-h-screen bg-slate-50/50 p-6 md:p-12 font-sans selection:bg-emerald-200">
      <div className="max-w-7xl mx-auto">
        <header className="mb-10">
          <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600">
            Punto de Venta
          </h1>
          <p className="text-slate-500 mt-2 font-medium">Terminal POS de OptiPlant Inventory</p>
        </header>
